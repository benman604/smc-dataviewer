    ...
    <div className="flex flex-1 min-h-0 bg-stone-100 border-r-4 border-stone-300">
      ...
      <main className="flex-1 min-h-0">
        <section className="h-full min-h-0 relative overflow-hidden">
          ...
          <div className={`absolute top-4 w-80 max-h-[calc(100%-2rem)] overflow-y-auto p-4 bg-white border border-stone-300 transition-all duration-300 ease-in-out ${panelOpen ? 'right-4 opacity-100 pointer-events-auto' : 'right-[-22rem] opacity-0 pointer-events-none'}`} style={{ zIndex: 100000 }} aria-hidden={!panelOpen}>
            <button
